...
int main(int argc, char **argv){
    ...
    //We prepare the file to read and to be hashed
    FILE *f_in;
    ...
    //we need nread because the fread function will return the number of bytes read
    //The cycle will continue until the end of the file
