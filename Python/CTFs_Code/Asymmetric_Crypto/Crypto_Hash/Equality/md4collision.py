...
#4字节
def Endian(b: bytes) -> list:
    # take each 4‐byte chunk, interpret as little‐endian unsigned int
...
def Collision():
  ...
  while 1:
    #随机的M
    m = bytes(random.getrandbits(8) for _ in range(64))
